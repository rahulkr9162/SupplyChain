...
public class SupplyChain extends Application {
    ...
    Label welcomeUser;
    public static final int width = 800, height = 500, upperLine = 50;
    ...
    private Pane headerBar() {
        ...
        welcomeUser = new Label("HEY! BUDDY");
    ...
    private Pane footerBar(){
        ...
        buyNowButton.setTranslateX(searchEnd-100);
    ...
    private  GridPane loginPage(){
        ...
        Label passwordLevel = new Label("password");
        ...
        gridPane.add(passwordLevel,0,1);
      ...
      private Pane CreateContent(){
       ...
       // bodyPane.setPrefSize(width,height);
        bodyPane.setTranslateY(upperLine-20);
        bodyPane.getChildren().add(productDetails.getAllProducts());
